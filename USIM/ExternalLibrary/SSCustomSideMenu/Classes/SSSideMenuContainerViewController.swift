...
open class SSSideMenuContainerViewController: UIViewController {
    ...
    private func configureMenuController() {
        ...
        self.menuContainerCorner()
        self.view.addSubview(menuContainerView)
    }
    
    func menuContainerCorner()  {
        menuContainerView.layer.borderWidth = 1.0
        menuContainerView.layer.borderColor = UIColor.lightGray.cgColor
        menuContainerView.layer.cornerRadius = 70
        menuContainerView.layer.maskedCorners = [.layerMaxXMinYCorner]
